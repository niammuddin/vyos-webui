          ...
          <div class="card h-100">
            <div class="card-header border-0">
              <nav>
                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                  <button class="nav-link active fw-bold" id="nav-as-path-list-tab" data-bs-toggle="tab" data-bs-target="#nav-as-path-list" type="button" role="tab" aria-controls="nav-as-path-list" aria-selected="true">AsPath List</button>
            ...
            <div class="card-body">
              <div class="tab-content mt-0">
                ...
                <div class="tab-pane fade show active" id="nav-as-path-list" role="tabpanel" aria-labelledby="nav-as-path-list-tab">
                  ...
                  <div class="table-responsive">
                    <table id="as-path-table" class="table table-hover text-nowrap display table-centered mb-0" style="width:100%">
...
<script src="./js/policy/as_path.js?<?= time();?>"></script>
